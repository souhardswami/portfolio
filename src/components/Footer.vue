  ...
  <div class="footer">
    ...
    <footer class="text-gray-400 bg-gray-900 body-font">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4  sm:py-2 sm:mt-0 mt-4">© 2021 souhard987 </p>
          <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">

            <a class="ml-3 text-gray-400 icon" href="https://www.linkedin.com/in/souhard-swami-9a2b651a2" target="_blank">
            ...
            <a class="ml-3 text-gray-400 icon" href="https://github.com/souhardswami" target="_blank">
            ...
            <a class="ml-3 text-gray-400 icon" href="mailto:souhardswami987@gmail.com" target="_blank">
            ...
            <a class="ml-3 text-gray-400 icon" href="https://www.facebook.com/souhard.swami.3/" target="_blank">
            ...
            <a class="ml-3 text-gray-400 icon" href="https://www.instagram.com/souhard_100/" target="_blank">
